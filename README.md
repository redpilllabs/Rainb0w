...
برای راه اندازی پروکسی REALITY، Hysteria و MTProto بدون نیاز به دامنه می‌توانید از [نسخه لایت](https://github.com/redpilllabs/Rainb0w-Lite) این اسکریپت استفاده نمایید.
