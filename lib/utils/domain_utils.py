...
def prompt_main_domain() -> str:
    print(
        """Your main domain will be used for the following:
    - HTTP (VMESS, Trojan)
    - NaiveProxy
    - Decoy (Fake) Website"""
    )
    main_domain = input("\nEnter your main domain (e.g example.com): ")
    while not is_domain(main_domain):
        print("\nInvalid domain name! Please enter in this format: example.com")
        main_domain = input("Enter your main domain (without any subdomains): ")
